...
<head>
    ...
    <title><?= lang('auth_login') ?> · Synapse</title>
...
<div class="w-full max-w-[480px] min-h-screen mx-auto relative overflow-hidden flex flex-col">
    ...
    <section class="h-[34vh] min-h-[260px] w-full relative flex flex-col items-center justify-center shrink-0">
        ...
        <p class="u-auth-tagline relative z-10 mt-3 text-sm font-medium text-center px-6 leading-relaxed"><?= lang('auth_tagline_login') ?></p>
    </section>
    ...
    <div class="auth-card flex-1 rounded-t-[2.5rem] w-full relative z-20 px-6 py-8 flex flex-col -mt-4">
        ...
        <!-- Login Form -->
        <h2 class="text-xl font-bold u-text mb-1"><?= lang('auth_login_title') ?></h2>
        <p class="text-sm u-text-2 mb-6"><?= lang('auth_login_subtitle') ?></p>

        <?= form_open('login', ['class' => 'space-y-4']) ?>

            <div>
                <label for="phone" class="text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5 block"><?= lang('auth_phone_label') ?></label>
            ...
            <div>
                <label for="password" class="text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5 block"><?= lang('auth_password_label') ?></label>
            ...
            <div>
                <label for="captcha" class="text-xs font-semibold text-slate-700 dark:text-slate-300 mb-1.5 block"><?= lang('auth_captcha_label') ?></label>
            ...
            <button type="submit" class="u-btn-dark h-14 w-full rounded-2xl shadow-lg flex items-center justify-center mt-2">
                <span><?= lang('auth_sign_in_btn') ?></span>
            </button>
        ...
        <p class="u-text-2 text-sm text-center mt-6">
            ...
            <a href="<?= site_url('register') ?>" class="text-blue-600 dark:text-blue-400 font-semibold hover:underline"><?= lang('auth_register_now') ?></a>
        </p>
    </div>
