...
<p>Type: <?php echo htmlspecialchars((string) get_class($exception), ENT_QUOTES, 'UTF-8'); ?></p>
<p>Message: <?php echo htmlspecialchars((string) $message, ENT_QUOTES, 'UTF-8'); ?></p>
<p>Filename: <?php echo htmlspecialchars((string) $exception->getFile(), ENT_QUOTES, 'UTF-8'); ?></p>
